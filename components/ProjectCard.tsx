...
const ProjectCard: FunctionComponent<{
    ...
    return (
        <div>
            <Image height={150} width={300} quality="100" layout="responsive" src={image_path} alt={name} className="cursor-pointer" onClick={() => setShowDetails(true)} />
                ...
                <div className="absolute top-0 left-0 z-10 grid w-full h-auto text-black bg-gray-100 md:grid-cols-2 gap-x-12 dark:text-white dark:bg-dark-100">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap mt-5 space-x-2 text-sm tracking-wider">
                            {
                                key_techs.map(tech =>( 
                                    <span key={tech+"tech"} className="px-2 py-1 bg-gray-200 rounded dark:bg-dark-200">
                                        {tech}
                                    </span>
                                ))
                            }
